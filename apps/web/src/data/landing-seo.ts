...
export const LANDING_FAQ: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      'Non. Questia est un outil de motivation et de structure, pas un dispositif médical ou psychologique. Si tu traverses une difficulté sérieuse, parle-en à un professionnel de santé.',
  },
  {
