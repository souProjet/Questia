...
export const SHOP_CATALOG: ShopCatalogEntry[] = [
  ...
  {
    /** Un seul achat en QC par compte une fois tout le contenu « permanent » obtenu ; avant le 1er achat du SKU, achetable même si le titre est déjà pris à l'unité (pour les bonus XP du lot). */
    sku: 'bundle_explorer',
    kind: 'bundle',
    name: 'Bundle Explorateur',
    description: `Un lot : 5 charges de bonus XP (+${XP_SHOP_BONUS_PER_CHARGE} XP par quête validée) et le titre Étincelle.`,
    priceCoins: 450,
    icon: 'Compass',
    grants: {
      xpBonusCharges: 5,
    ...
    contentsDetail:
      "Les thèmes d'interface (Nuit boréale, Aurore, Parchemin, etc.) sont inclus pour tout le monde : tu les choisis dans les réglages. Ce bundle ajoute surtout du bonus XP et le titre Étincelle.",
    marketing: {
      badge: 'featured',
      hook: "Moins cher que d'acheter le bonus XP et le titre séparément.",
      savingsCoins: 80,
      compareAtCoins: 530,
    },
  },
