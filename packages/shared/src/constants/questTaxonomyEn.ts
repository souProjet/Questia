/**
 * Titres et concepts EN pour la taxonomie (alignés sur les ids FR dans quests.ts).
 */
export const QUEST_TAXONOMY_EN: Record<
  number,
  {
    titleEn: string;
...
> = {
  ...
  24: {
    ...
    descriptionEn: 'Plan a full week as if your life depended on it: blocks, priorities, contingencies.',
  },
  25: {
